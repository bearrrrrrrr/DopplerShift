/datum/antag_faction/echoes
	...
	The severity of the incident was under-exaggerated by the regional administration so that such a catastrophic fuck-up wouldn't cost all of you your jobs. The Port Authority central office was left oblivious, believing it to be a simple mix-up. They are increasing performance-rewards to get one crew to out-compete the other and replace them. Either hired by EDL, or part of the crew, you don't intend to mess up now.."
