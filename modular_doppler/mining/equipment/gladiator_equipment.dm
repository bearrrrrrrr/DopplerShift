...
/obj/structure/closet/crate/necropolis/gladiator/PopulateContents() //you think the clang is gone because i think it's LRP and too loud? WRONG! it's gone because i'm too lazy to port a single .ogg!
...
/obj/structure/closet/crate/necropolis/gladiator/crusher/PopulateContents() //.......and also because it's loud
	new /obj/item/claymore/dragonslayer(src)
	new /obj/item/clothing/suit/hooded/berserker/gatsu(src)
	new /obj/item/clothing/neck/warrior_cape(src)
